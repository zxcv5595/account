...
class TransactionServiceTest {
    ...
    @Test
    @DisplayName("유저 조회 실패 - 잔액 사용 실패")
    void useBalance_NotFoundUser() {
        //given
        given(accountUserRepository.findById(anyLong()))
    ...
    @Test
    @DisplayName("계좌 조회 실패 - 잔액 사용 실패")
    void useBalance_NotFoundAccount() {
        //given
        AccountUser user = AccountUser.builder()
                .name("Pobi").build();
        user.setId(125L);
    ...
    void cancelBalance_NotFoundAccount() {
        //given
        given(transactionRepository.findByTransactionId(anyString()))
    ...
    void cancelBalance_NotFoundTransaction() {
        //given
        given(transactionRepository.findByTransactionId(anyString()))
                .willReturn(Optional.empty());
        //when
